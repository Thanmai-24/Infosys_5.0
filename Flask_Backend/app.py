...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', 'postgresql://postgres:Iris3907@localhost/fraud_detection_db')
...
class AadhaarVerificationSystem:
    def __init__(self, upload_folder, classifier_path, detector_path):
        ...
        # Initialize models
        self.classifier = YOLO(os.path.join(os.getcwd(), 'models', 'classifier.pt'))
        self.detector = YOLO(os.path.join(os.getcwd(), 'models', 'detector.pt'))
